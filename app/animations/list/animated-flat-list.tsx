      ...
      >
        <View className="border-b border-slate-200 px-6 py-4">
          <Text className="mt-1 text-sm text-slate-600">
            Use Animated.createAnimatedComponent(FlatList) so the list supports
            Reanimated. Each item can use entering for a staggered mount animation.
          </Text>
