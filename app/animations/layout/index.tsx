  ...
  return (
    <>
      <View className="flex-row items-center border-b border-slate-200 bg-white px-4 py-3">
        ...
        <Text className="text-lg font-semibold text-slate-900">Layout</Text>
      </View>
      <ScrollView
      ...
      >
        <View className="px-6 pb-10 pt-6">
          ...
          <Text className="mt-2 text-slate-600">
            Layout animations—enter, exit, reorder, expand
          </Text>
        </View>
            ...
            {DEMOS.map((demo) => (
              ...
              >
                <View className="flex-row items-center p-5">
                  <View className="mr-4 h-12 w-12 shrink-0 items-center justify-center rounded-xl bg-lime-100">
                    <Ionicons name="resize" size={26} color="#84cc16" />
                  </View>
