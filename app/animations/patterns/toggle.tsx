  ...
  return (
    <>
      <View className="flex-row items-center border-b border-slate-200 bg-white px-4 py-3">
        ...
        <Text className="text-lg font-semibold text-slate-900">Toggle</Text>
      </View>
      <ScrollView
      ...
      >
        <View className="border-b border-slate-200 px-6 py-4">
          <Text className="mt-1 text-sm text-slate-600">
            Toggle between two states. Animate from current value to target—
            Reanimated handles interpolation. Perfect for switches, expand/collapse.
          </Text>
