  ...
  return (
    <>
      <View className="flex-row items-center border-b border-slate-200 bg-white px-4 py-3">
        ...
        <Text className="text-lg font-semibold text-slate-900">Patterns</Text>
      </View>
      <ScrollView
      ...
      >
        <View className="px-6 pb-10 pt-6">
          <Text className="text-2xl font-bold text-slate-900">Patterns</Text>
          <Text className="mt-2 text-slate-600">
            Common animation patterns and architectures
          </Text>
        </View>
              ...
              >
                <View className="flex-row items-center p-5">
                  <View className="mr-4 h-12 w-12 items-center justify-center rounded-xl bg-indigo-100">
                    <Ionicons name="git-merge" size={26} color="#6366f1" />
                  </View>
