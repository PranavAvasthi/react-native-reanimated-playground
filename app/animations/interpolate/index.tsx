    ...
    <>
      ...
      >
        <View className="px-6 pb-10 pt-6">
          <Text className="text-2xl font-bold text-slate-900">Interpolate</Text>
          <Text className="mt-2 text-slate-600">
            Map values between ranges with interpolate
          </Text>
        </View>
            ...
            {DEMOS.map((demo) => (
              ...
              >
                <View className="flex-row items-center p-5">
                  <View className="mr-4 h-12 w-12 items-center justify-center rounded-xl bg-rose-100">
                    <Ionicons
